...
public class Constants {
	...
	public static final String INSERT_SENSOR_OBSERVABLE_PROPERTY_OUTPUT_NAME_PLACEHOLDER = "%OBSERVABLE_PROPERTY_OUTPUT_NAME%";
	public static final String INSERT_SENSOR_OBSERVABLE_PROPERTY_OUTPUT_VALUE_PLACEHOLDER = "%OBSERVABLE_PROPERTY_OUTPUT_VALUE%";

	public static final String INSERT_SENSOR_OBSERVABLE_PROPERTY_OUTPUT_UOM_PLACEHOLDER = "%UOM_DEFINITION%";
	 ...
	 */
	public static final String OBSERVABLE_PROPERTY_INPUT_NAME = "Wasserdurchfluss";
	public static final String OBSERVABLE_PROPERTY_INPUT_VALUE = "Wasserdurchfluss";
	public static final String OBSERVABLE_PROPERTY_OUTPUT_NAME = "Wasserdurchfluss";
	public static final String OBSERVABLE_PROPERTY_OUTPUT_VALUE = "Wasserdurchfluss";
